...
class Step < Formula
  ...
  url "https://dl.step.sm/gh-release/cli/homebrew-local/v0.18.1/step_0.18.1.tar.gz"
  sha256 "88347013784eae1eed7622b3a35805db2eeef7df52dcd044bb89fc325deee9fe"
  license "Apache-2.0"

  depends_on "go" => :build

  resource "certificates" do
    url "https://dl.step.sm/gh-release/certificates/homebrew-local/v0.18.1/step-ca_0.18.1.tar.gz"
    sha256 "06bc91161cb755e5b74814a3d92e08027182af1ee23f882480b897211359bdbc"
  end
