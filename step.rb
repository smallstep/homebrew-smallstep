...
class Step < Formula
  ...
  url "https://dl.step.sm/gh-release/cli/homebrew-local/v0.18.0/step_0.18.0.tar.gz"
  ...
  resource "certificates" do
    url "https://dl.step.sm/gh-release/certificates/homebrew-local/v0.18.0/step-ca_0.18.0.tar.gz"
