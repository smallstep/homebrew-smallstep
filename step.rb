...
class Step < Formula
  ...
  url "https://dl.step.sm/gh-release/cli/homebrew-local/v0.23.1/step_0.23.1.tar.gz"
  ...
  resource "certificates" do
    url "https://dl.step.sm/gh-release/certificates/homebrew-local/v0.23.1/step-ca_0.23.1.tar.gz"
